...
/* =========================================================
   ...
   ========================================================= */
const LUMINA_APP_VERSION = "7.1.3";
...
const LUMINA_BANNER_IMAGES = [
  ...
  {
    src: "https://images.unsplash.com/photo-1525507119028-ed4c629a60a3?auto=format&fit=crop&w=1600&q=88",
    alt: "Moda RAYSSA PRIME BEAUTY"
  },
  {
    src: "https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&w=1600&q=88",
    alt: "Novidades de moda RAYSSA PRIME BEAUTY"
  },
  {
...
/* Segundo banner: reutiliza as imagens configuradas pela Rayssa para manter o conteúdo centralizado em um único ponto. */
const LUMINA_NEW_BANNER_IMAGES = LUMINA_BANNER_IMAGES.map((item, index) => ({
  ...item,
  alt: item.alt || `Novidades RAYSSA PRIME BEAUTY ${index + 1}`
}));
window.LUMINA_NEW_BANNER_IMAGES = LUMINA_NEW_BANNER_IMAGES;
